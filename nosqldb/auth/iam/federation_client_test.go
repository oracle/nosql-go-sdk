...
func TestX509FederationClient_ClientHost(t *testing.T) {
	...
	testDataSet := []testData{
		...
		},
		{
			...
			expected: "auth.us-gov-phoenix-1.oraclegovcloud.com",
		},
	}

	for _, testData := range testDataSet {
		federationClient := &x509FederationClient{}
		region, _ := common.StringToRegion(testData.region)
		federationClient.authClient, _ = newAuthClient(region, federationClient)
...
fwIDAQAB`
	...
	expectedSecurityToken = `eyJhbGciOiJSUzI1NiIsImtpZCI6ImFzdyIsInR5cCI6IkpXVCJ9..zen7q2yJSpMjzH4ym_H7VEwZA0-vTT4Wcild-HRfLxX6A1ej4tlpACa7A24j5JoZYI4mHooZVJ8e7ZezFenK0zZx5j8RbIjsqJKwroYXExOiBXLCUwMWOLXIndEsUzzGLqnPfKHXd80vrhMLmtkVTCJqBMzvPUSYkH_ciWgmjP9m0YETdQ9ifghkADhZGt9IlnOswg0s3Bx9ASwxFZEtom0BmU9GwEuITTTZfKvndk785BlNeZMOjhovaD97-LYpv5B_PiWEz8zialK5zxjijLCw06zyA8CQRQqmVCagNUPilfz_BcPyImzvFDuzQcPyDkTcsB7weX35tafHmA_Ulg`
)
...
const whateverRegion = regionPHX
...
func (m *mockSecurityToken) ExpirationTime() time.Time {
