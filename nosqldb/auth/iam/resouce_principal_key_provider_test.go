...
const (
	rpTestEncryptedPrivateKey = `-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----`
	rpTestKeyPassphrase = "goisfun"

	// Generated key duplicates the Java SDK test resources

	rpTestPrivateKey = `-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----`
	...
	rpst      = `eyJraWQiOiJhc3ciLCJhbGciOiJSUzI1NiJ9..LqRt9JXSdcLahdwACjw_p_KHQhKde-NaVZG3zMjzWX6bVad-SRZYWKQSlk6Tq4f1ZNN0uxlP-d2snQAp3Kw-cQRrdCDOmD_0CDgR-yre-YbJDsJbEncczUIbe-ASeq_Sh9zDROVuD_7NdrmUCiVH2g-UYpYkuKKqu_tVjL2uy77W5_DGobPArEFvZ2GnyHT7gVVv12RnINtgr2jJULhegPBfvnp9-fhhZ7_PcsJ7Z5FkPzLtLOwEm3Lbm3veyUVUviu1CSjXnK67KzjS18TVGi723bkxYBf9lYDHfaXh9EEHzPtxeLAl3VrGjwZUv_ih0FRmoM7wgq8HMRjNACMo6g`
	regionPHX = "us-phoenix-1"
)

var ppEnvVars = map[string]string{
	resourcePrincipalVersionEnvVar:              resourcePrincipalVersion2_2,
	resourcePrincipalRegionEnvVar:               regionPHX,
	resourcePrincipalRPSTEnvVar:                 rpst,
	resourcePrincipalPrivatePEMEnvVar:           rpTestEncryptedPrivateKey,
	resourcePrincipalPrivatePEMPassphraseEnvVar: rpTestKeyPassphrase,
}
...
var envVars = map[string]string{
	...
	resourcePrincipalRegionEnvVar:     regionPHX,
	resourcePrincipalRPSTEnvVar:       rpst,
	resourcePrincipalPrivatePEMEnvVar: rpTestPrivateKey,
}
...
func TestResourcePrincipalKeyProvider(t *testing.T) {
	...
	provider, e := newResourcePrincipalConfigurationProvider()
...
func TestResourcePrincipalKeyProvider_MissingEnvVars(t *testing.T) {
	...
	for _, v := range testVars {
		...
		_, e := newResourcePrincipalConfigurationProvider()
...
func TestResourcePrincipalConfigurationProvider(t *testing.T) {
	...
	assert.NoError(t, e)
	assert.Equal(t, regionPHX, region)
